...
type CommonProtocol struct {
	...
	OnAfterAutoMatchmakeWithGatheringIDPostpone    func(packet nex.PacketInterface, lstGid types.List[types.UInt32])
...
func NewCommonProtocol(protocol matchmake_extension.Interface) *CommonProtocol {
	...
	protocol.SetHandlerAutoMatchmakeWithGatheringIDPostpone(commonProtocol.autoMatchmakeWithGatheringIDPostpone)
