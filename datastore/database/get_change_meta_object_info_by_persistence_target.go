...
func GetChangeMetaObjectInfoByPersistenceTarget(manager *common_globals.DataStoreManager, persistenceTarget datastore_types.DataStorePersistenceTarget) (datastore_types.DataStoreMetaInfo, types.UInt64, *nex.Error) {
	...
	return GetChangeMetaObjectInfoByDataID(manager, dataID)
}
