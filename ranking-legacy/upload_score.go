...
func (commonProtocol *CommonProtocol) uploadScore(err error, packet nex.PacketInterface, callID uint32, uniqueID types.UInt32, category types.UInt32, scores types.List[types.UInt32], unknown1 types.UInt8, unknown2 types.UInt32) (*nex.RMCMessage, *nex.Error) {
	if err != nil {
	...
	rmcResponse.MethodID = rankinglegacy.MethodUploadScore
