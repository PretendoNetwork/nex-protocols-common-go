...
func InsertInstantBinaryMessage(manager *common_globals.MessagingManager, message messaging_types.BinaryMessage, recipientID types.UInt64, recipientType messaging_constants.RecipientType) *nex.Error {
	var err error
