...
type UtilityManager struct {
	...
	GenerateNEXUniqueID             func(manager *UtilityManager, packet nex.PacketInterface) (uint64, *nex.Error)
	GenerateNEXUniqueIDWithPassword func(manager *UtilityManager, packet nex.PacketInterface) (uint64, uint64, *nex.Error)
